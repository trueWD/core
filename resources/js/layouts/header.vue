						...
						<div class="row row-cols-1 row-cols-sm-2 g-0">
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom p-3">
									<div>
										<img :src="'/global_assets/images/demo/logos/1.svg'" class="h-40px mb-2" alt="">
							...
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-bottom p-3">
									<div>
										<img :src="'/global_assets/images/demo/logos/2.svg'" class="h-40px mb-2" alt="">
							...
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom border-bottom-sm-0 rounded-bottom-start p-3">
									<div>
										<img :src="'/global_assets/images/demo/logos/3.svg'" class="h-40px mb-2" alt="">
							...
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start rounded-bottom-end p-3">
									<div>
										<img :src="'/global_assets/images/demo/logos/4.svg'" class="h-40px mb-2" alt="">
						...
						<div class="dropdown-menu-scrollable pb-2">
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img :src="'/global_assets/images/demo/users/face10.jpg'" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img :src="'/global_assets/images/demo/users/face3.jpg'" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img :src="'/global_assets/images/demo/users/face24.jpg'" class="w-40px h-40px rounded-pill" alt="">
									<span class="status-indicator bg-success"></span>
								</div>
								<div class="flex-1">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img :src="'/global_assets/images/demo/users/face4.jpg'" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img :src="'/global_assets/images/demo/users/face25.jpg'" class="w-40px h-40px rounded-pill" alt="">
						...
						<div class="dropdown-menu w-100" data-color-theme="light">
							...
							<div class="dropdown-menu-scrollable-lg">
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img :src="'/global_assets/images/demo/users/face3.jpg'" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img :src="'/global_assets/images/demo/users/face24.jpg'" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img :src="'/global_assets/images/brands/adobe.svg'" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img :src="'/global_assets/images/brands/holiday-inn.svg'" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img :src="'/global_assets/images/brands/ing.svg'" class="w-32px h-32px rounded-pill" alt="">
									</div>
				...
				<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
					<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
						<div class="status-indicator-container">
							<img v-if="useAppStore.user.media" :src="useAppStore.user?.media?.original_url" class="w-32px h-32px rounded-pill" alt="">
							<img v-else :src="'/global_assets/images/no_avatar.png'" class="w-32px h-32px rounded-pill" alt="">
							<span class="status-indicator bg-success"></span>
						</div>
						<span class="d-none d-lg-inline-block mx-lg-2">{{ useAppStore.user.name}}</span>
					</a>
					...
					<div class="dropdown-menu dropdown-menu-end">
						...
						<a href="#" class="dropdown-item" @click="login.logout()">
